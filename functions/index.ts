 ...
 */
export const sharePremiumWithPartner = onDocumentUpdated('users/{userId}', async (event) => {
 ...
 */
async function notifyUser(userData: FirebaseFirestore.DocumentData | undefined, title: string, body: string) {
  if (!userData) return;
